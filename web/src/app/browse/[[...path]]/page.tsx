...
function BrowseContent() {
    ...
    const getInitialData = () => {
        ...
        if (previousPath && browseCache.has(previousPath)) return browseCache.get(previousPath)!;
        return null;
    };
    ...
    if (!data && isFetching) return <BrowseSkeleton isMaterial={isLikelyMaterial} />;
    ...
    if (data.type === "material" && data.material) {
        return <MaterialViewer material={data.material} breadcrumbs={data.breadcrumbs} />;
    }
