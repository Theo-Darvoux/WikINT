    ...
    return (
        <div className="mx-auto max-w-3xl space-y-8 py-8 px-4">
            ...
            <section className="space-y-3">
                ...
                <p className="text-muted-foreground leading-relaxed">
                    Your data is processed solely to operate the platform: authenticating your
                    identity, displaying your contributions, sending notifications, and enabling
                    collaboration between users. We do not sell, share, or transfer your data to
                    third parties.
                </p>
            </section>
            ...
            <section className="space-y-3">
                ...
                <p className="text-muted-foreground leading-relaxed">
                    ...
                    irrevocable, perpetual, royalty-free license to host, display, distribute,
                    and make available the contributed content for the benefit of the community.
                    Uploaded materials become the property of WikINT and its creators.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                    This means that contributed materials (documents, files, media) will remain
                    on the platform even if you delete your account. Your personal information
                    (name, email) will be disassociated from the content upon account deletion,
                    but the content itself will be retained to preserve the knowledge base for
                    all users.
                </p>
            </section>
            ...
            <section className="space-y-3">
                ...
                <p className="text-muted-foreground leading-relaxed">
                    WikINT uses strictly necessary cookies to keep you logged in and store your
                    preferred theme. We do not use third-party tracking cookies or analytics
                    services.
                </p>
            </section>
            ...
            <section className="space-y-3">
                ...
                <p className="text-muted-foreground leading-relaxed">
                    For questions about this privacy policy or your data, contact the platform
                    administrators at Telecom SudParis / IMT-BS.
                </p>
            </section>
        </div>
    );
