...
function SkeletonCard() {
    return (
        <div className="w-[220px] flex-none rounded-xl border bg-card shadow-sm overflow-hidden">
...
function SeeAllFavouritesCard() {
    return (
        <Link
            href="/profile"
            className="block w-[180px] flex-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-xl"
            aria-label="See all favourites"
        >
            <div className="flex h-full min-h-[200px] flex-col items-center justify-center gap-3 rounded-xl border border-dashed bg-muted/30 p-4 text-center transition-colors hover:bg-muted/60">
