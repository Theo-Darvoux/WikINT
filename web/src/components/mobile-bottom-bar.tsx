    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-50 border-t bg-background/95 backdrop-blur-sm">
            <div className="flex h-14 items-center justify-around">
                ...
                <Link href="/notifications" className="relative flex flex-col items-center gap-0.5 text-xs text-muted-foreground hover:text-foreground">
                ...
                <Link href="/profile" className="flex flex-col items-center gap-0.5 text-xs text-muted-foreground hover:text-foreground">
